...
import com.rosyid.noteeku.database.NotesDatabase
import com.rosyid.noteeku.entities.Notes
import com.rosyid.noteeku.util.NoteBottomSheetFragment
...
class CreateNoteFragment : BaseFragment(),EasyPermissions.PermissionCallbacks,EasyPermissions.RationaleCallbacks{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnOk.setOnClickListener {
            if (etWebLink.text.toString().trim().isNotEmpty()){
                ...
                Toast.makeText(requireContext(),"Tolong Masukkan Link",Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun saveNote(){
        ...
        if (etNoteTitle.text.isNullOrEmpty()){
            Toast.makeText(context,"Tolong Masukkan Judul",Toast.LENGTH_SHORT).show()
        }
...
//        }
            ...
            Toast.makeText(context,"Tolong Masukkan Isi",Toast.LENGTH_SHORT).show()
        }
